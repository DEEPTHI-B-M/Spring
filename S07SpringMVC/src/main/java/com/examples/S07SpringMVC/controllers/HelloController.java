...
public class HelloController {
	...
	public ModelAndView hello() {
		...
		modelView.addObject("name", "Deepthi");
	...
	public ModelAndView readEmployee() {
		ModelAndView modelView = new ModelAndView();
		Employee employee = new Employee(1, "Deepthi", 20000);
	...
	public ModelAndView readEmployees() {
		ModelAndView modelView = new ModelAndView();
		Employee employee1 = new Employee(1, "Deepthi", 20000);
		Employee employee2 = new Employee(2, "Divya", 20000);
